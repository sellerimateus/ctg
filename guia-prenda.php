...
<head>
  ...
  <meta name="description" content="Materiais de estudo para a modalidade Prenda.">
  <title>Guia da Prenda | CTG Sentinela da Serra</title>
  <link rel="stylesheet" href="assets/css/global.css?v=1">
  <script defer src="assets/js/visual.js?v=2"></script></head>
<body class="pagina-guia-prenda estilo-guia-concorrente">
<a class="skip-link" href="#conteudo">Ir para o conteúdo</a>
<div aria-hidden="true" class="topo-faixa"></div>
<?php
$paginaAtual = 'guia-prenda';
$tipoMenu = 'guia';
$headerEstruturaMobile = false;
require __DIR__ . '/includes/header.php';
?>
<main id="conteudo">
<section class="orientacoes-chamada" id="orientacoes">
<div class="container">
<h2>Guia da Prenda</h2>
<p>Um espaço de estudo para a Prenda, com organização e materiais relacionados.</p>
</div>
</section>
<section class="secao" id="provas">
<div class="container">
<div class="secao-titulo">
<div>
<h2>Entre no espaço da sua prova.</h2>
</div>
</div>
<div class="grade-provas">
<article class="prova-card campeira">
<span class="prova-numero">01</span>
<h3>Prova Folclórica</h3>
<p>Folclore gaúcho, cultura, história e tradição para a preparação da Prenda.</p>
<ul class="prova-lista">
<li>Referências de folclore e tradição</li>
<li>História, cultura e costumes gaúchos</li>
<li>Organização para a apresentação</li>
</ul>
<a class="botao" href="prova-campeira.php">Entrar no espaço folclórico →</a>
</article>
<article class="prova-card artistica">
<span class="prova-numero">02</span>
<h3>Prova Artística</h3>
<p>Ensaio, interpretação, apresentação, indumentária e presença de palco.</p>
<ul class="prova-lista">
<li>Organização dos ensaios</li>
<li>Expressão e apresentação</li>
<li>Revisão da indumentária</li>
</ul>
<a class="botao" href="prova-artistica.php">Entrar no espaço artístico →</a>
</article>
<article class="prova-card escrita">
<span class="prova-numero">03</span>
<h3>Prova Escrita</h3>
<p>Leitura, interpretação, revisão de conteúdo, simulados e controle do tempo.</p>
<ul class="prova-lista">
<li>Plano de estudos</li>
<li>Técnica para interpretar questões</li>
<li>Simulados e revisão de erros</li>
</ul>
<a class="botao" href="prova-escrita.php">Entrar no espaço de estudos →</a>
</article>
</div>
</div>
</section>
...
<h2>CTG Sentinela da Serra</h2>
<small class="rodape-cnpj">CNPJ: 00.000.000/0000-00</small>
</div>
<div class="rodape-redes">
<h3>Redes sociais</h3>
<div class="rodape-redes-links">
<a aria-label="Instagram do CTG Sentinela da Serra" class="rodape-rede" href="https://www.instagram.com/ctg_sentineladaserra?igsh=MWh3dzB1bW16Mmw0aQ==" rel="noopener noreferrer" target="_blank">
...
<a aria-label="Facebook do CTG Sentinela da Serra" class="rodape-rede" href="https://www.facebook.com/share/1Co5ZCNmHT/?mibextid=wwXIfr" rel="noopener noreferrer" target="_blank">
<span aria-hidden="true" class="rodape-rede-icone">
<svg viewbox="0 0 24 24">
...
<button aria-label="Fechar pesquisa" class="icone-botao busca-fechar" type="button">×</button>
</div>
<input aria-label="Termo de pesquisa" class="busca-campo" placeholder="Ex.: guia, prova, estudo..." type="search"/>
...
</script><button class="botao-voltar-pagina" type="button" onclick="history.length > 1 ? history.back() : location.href='escolha-modalidade.php'">Voltar</button></body>
</html>
